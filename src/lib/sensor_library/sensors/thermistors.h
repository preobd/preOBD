...
static const char PSTR_JEEP_4_0_TEMP_GAUGE_LABEL[] PROGMEM = "Jeep 4.0L Coolant Temp Sender (Gauge) (-40-130" "\xC2\xB0" "C)";
static const char PSTR_JEEP_RENIX_CTS[] PROGMEM = "JEEP_RENIX_CTS";
static const char PSTR_JEEP_RENIX_CTS_LABEL[] PROGMEM = "Jeep Renix ECU Coolant Temp Sensor (-40-180" "\xC2\xB0" "C)";
...
#define THERMISTOR_SENSORS \
    ...
    X_SENSOR(PSTR_JEEP_4_0_TEMP_GAUGE, PSTR_JEEP_4_0_TEMP_GAUGE_LABEL, nullptr, readThermistorLookup, nullptr, \
             MEASURE_TEMPERATURE, CAL_THERMISTOR_TABLE, &jeep40_temp_gauge_cal, SENSOR_READ_INTERVAL_MS, -40.0, 130.0, 0x29E8, PIN_ANALOG) \
    X_SENSOR(PSTR_JEEP_RENIX_CTS, PSTR_JEEP_RENIX_CTS_LABEL, nullptr, readThermistorLookup, nullptr, \
             MEASURE_TEMPERATURE, CAL_THERMISTOR_TABLE, &renix_cts_cal, SENSOR_READ_INTERVAL_MS, -40.0, 180.0, 0x34F7, PIN_ANALOG) \
    /* Linear temperature */ \
