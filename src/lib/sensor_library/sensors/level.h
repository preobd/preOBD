...
static const char PSTR_SW_FUEL_LEVEL_240_DESC[] PROGMEM = "Stewart-Warner fuel sender, 240\xCE\xA9 empty, 33\xCE\xA9 full. Published endpoints, interpolated midpoints.";
...
static const char PSTR_SW_FORD_FUEL_LEVEL_DESC[] PROGMEM = "Ford/Chrysler fuel sender (1960s-1980s). 73\xCE\xA9 empty, 10\xCE\xA9 full. SW cross-reference spec.";
