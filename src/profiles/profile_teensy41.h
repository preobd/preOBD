 ...
 *
 * This file is the authoritative board definition for the Teensy 4.1.
...
// ===== JSON CAPABILITY =====
// SUPPORTS_JSON_CONFIG enables JSON over serial/BLE.
// JSON-to-SD (saveConfigToSD / loadConfigFromSD) is automatically gated on
// SUPPORTS_SD — no extra flag needed.
