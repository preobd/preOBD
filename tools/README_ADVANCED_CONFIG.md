...
The preOBD configuration tool now supports custom calibrations through the `advanced_config.h` file. This feature allows you to define custom sensor calibrations that override the default presets.
...
// Generated by preOBD-config v1.0.0 on 2025-12-18 19:45:36
// Platform: uno
...
- `tools/preobd_config/config_generator.py` - Code generation functions
