...
1. **Initial Setup:**
   ...
   SET 2 CAL SPEED 100 2008 3.73 1.0 2000 300
   SAVE
   ```
...
4. **Update and Save:**
   ```
   SET 2 CAL SPEED 100 2008 3.73 1.05 2000 300
   SAVE
   ```
...
```
SET 2 VEHICLE_SPEED HALL_SPEED
SET 2 CAL SPEED 100 2008 3.54 1.0 2000 250
SAVE
```
...
```
SET 2 VEHICLE_SPEED HALL_SPEED
SET 2 CAL SPEED 100 2436 3.73 1.0 2000 200
SAVE
```
...
```
SET 2 VEHICLE_SPEED HALL_SPEED
SET 2 CAL SPEED 100 2616 4.10 1.0 2000 160
SAVE
```
